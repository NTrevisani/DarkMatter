...
// Tue Feb 17 12:28:28 2015 by ROOT version 5.34/09
// from TTree Delphes/Analysis tree
// found on file: /afs/cern.ch/user/d/dburns/public/HWWSignalMC/ppTOhxx_hTO2wTO2l2v_100GeV_13TeV.root
//////////////////////////////////////////////////////////

#ifndef DelphesTree13_h
#define DelphesTree13_h
...
const Int_t kMaxParticle = 940;
const Int_t kMaxTrack = 125;
const Int_t kMaxTower = 410;
const Int_t kMaxEFlowTrack = 125;
const Int_t kMaxEFlowPhoton = 210;
const Int_t kMaxEFlowNeutralHadron = 159;
...
public :
   ...
   DelphesTree13(TTree *tree=0);
   virtual ~DelphesTree13();
...
#ifdef DelphesTree13_cxx
DelphesTree13::DelphesTree13(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/user/d/dburns/public/HWWSignalMC/ppTOhxx_hTO2wTO2l2v_100GeV_13TeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/user/d/dburns/public/HWWSignalMC/ppTOhxx_hTO2wTO2l2v_100GeV_13TeV.root");
      }
...
DelphesTree13::~DelphesTree13()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DelphesTree13::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DelphesTree13::LoadTree(Long64_t entry)
{
...
void DelphesTree13::Init(TTree *tree)
{
...
void DelphesTree13::Show(Long64_t entry)
{
...
Int_t DelphesTree13::Cut(Long64_t entry)
{
