...
//=========  (Mon Feb  9 13:16:55 2015) by ROOT version5.34/09
   ...
   TH1F *hLatino = new TH1F("hLatino","jetphi2",100,-126.3317,126.3317);
   hLatino->SetBinContent(0,0.1540199);
   hLatino->SetBinContent(49,0.0973517);
   hLatino->SetBinContent(50,0.398482);
   hLatino->SetBinContent(51,0.4072374);
   hLatino->SetBinContent(52,0.09692889);
   ...
   TH1F *hDark = new TH1F("hDark","jetphi2",100,-126.3317,126.3317);
   hDark->SetBinContent(49,0.08348594);
   hDark->SetBinContent(50,0.4038565);
   hDark->SetBinContent(51,0.4113972);
   hDark->SetBinContent(52,0.1012604);
   ...
   TLegend *leg = new TLegend(2.121996e-314,2.121996e-314,-nan,0,NULL,"brNDC");
   leg->SetBorderSize(1);
   leg->SetLineColor(0);
   leg->SetLineStyle(1);
   leg->SetLineWidth(1);
