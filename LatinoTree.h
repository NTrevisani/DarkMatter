...
// Wed Feb 11 13:03:54 2015 by ROOT version 5.34/09
// from TTree latino/probe_tree
// found on file: ../public/latinoHWW/latino_1125_ggToH125toWWTo2LAndTau2Nu.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../public/latinoHWW/latino_1125_ggToH125toWWTo2LAndTau2Nu.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../public/latinoHWW/latino_1125_ggToH125toWWTo2LAndTau2Nu.root");
      }
