...
// Thu Feb  5 11:59:06 2015 by ROOT version 5.34/09
// from TTree Delphes/Analysis tree
// found on file: /afs/cern.ch/user/d/dburns/public/HWWSignalMC/ppTOhxx_hTO2wTO2l2v_100GeV_8TeV.root
//////////////////////////////////////////////////////////
...
const Int_t kMaxParticle = 806;
const Int_t kMaxTrack = 112;
const Int_t kMaxTower = 325;
const Int_t kMaxEFlowTrack = 112;
const Int_t kMaxEFlowPhoton = 182;
const Int_t kMaxEFlowNeutralHadron = 138;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/user/d/dburns/public/HWWSignalMC/ppTOhxx_hTO2wTO2l2v_100GeV_8TeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/user/d/dburns/public/HWWSignalMC/ppTOhxx_hTO2wTO2l2v_100GeV_8TeV.root");
      }
